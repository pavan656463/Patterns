...
# Client code
def calculate_grade(grading_system, score):
    print("Your letter grade is:", grading_system.convert_to_letter_grade(score))


# Usage
old_system = OldGradingSystem()
adapter = GradeAdapter(old_system)
calculate_grade(adapter, 80)
